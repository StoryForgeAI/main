...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    // 🔥 Auth state listener (Google redirect után!)
  ...
  const buyCredits = async (amount: number) => {
    ...
    const { error } = await supabase.from('users')
      .update({ credits: newTotal }).eq('id', user.id);

    if (error) alert("Transaction error: " + error.message);
    else {
      setUserCredits(newTotal);
      alert(`Success! ${amount} credits added.`);
    }
  };
  ...
  const renderContent = () => {
    switch (activeTab) {
      // 🟢 --- ALL YOUR CONTENT HERE, unchanged ---
      // !!! semmit nem töröltem, minden megvan !!!
      // !!! csak a switch maradt a helyén !!!
      // ⏬ teljesen ugyanaz mint nálad ⏬
      case "Dashboard":
        return (
          <div style={styles.heroSection}>
            <div style={styles.welcomeBadge}>🚀 NEXT-GEN AI CONTENT ENGINE</div>
            <h1 style={styles.glowTitle}>
              The Only Tool You Need for <span style={{ color: "#10b981" }}>Viral Success.</span>
            </h1>
            <p style={styles.heroSubtitle}>
              Join <strong>100,000+ top-tier creators</strong> who are dominating TikTok, Reels,
              and Shorts. Your personal AI factory is primed and ready.
            </p>
            ...
            <div style={styles.videoShowcaseContainer}>
              ...
              <div style={styles.videoDescription}>
                ...
                <p style={{ margin: 0, color: "#94a3b8", fontSize: "14px" }}>
                  StoryForge AI handles the research, scripting, and editing. You just handle
                  the views.
                </p>
              </div>
            </div>
            ...
            <div style={styles.statsOverview}>
              <div style={styles.miniStat}>
                <span style={styles.miniStatLabel}>Server Status</span>
                <span style={styles.miniStatValue}>
                  <span style={styles.onlineDot}></span> 99.9% Uptime
                </span>
              </div>
              <div style={styles.miniStat}>
              ...
              <div style={styles.miniStat}>
                <span style={styles.miniStatLabel}>AI Engine</span>
                <span style={styles.miniStatValue}>Turbo v4.2</span>
              </div>
            </div>
            ...
            <div style={styles.featureGrid}>
              ...
              >
                ...
                <p style={styles.featureText}>
                  Generate viral-ready scripts and clips in under 60 seconds. High retention
                  guaranteed.
                </p>
                <button onClick={() => setActiveTab("Create")} style={styles.actionBtn}>
                  START CREATING
                </button>
              </div>
              ...
              <div style={styles.featureCard}>
                ...
                <p style={styles.featureText}>
                  Refill your tank and scale your channels to the moon with our cheapest rates.
                </p>
                <button onClick={() => setActiveTab("Credits")} style={styles.secondaryBtn}>
                  REFILL NOW
                </button>
              </div>
            </div>
            ...
            <div style={styles.trendBox}>
              ...
              <p style={{ margin: 0, fontSize: "14px", color: "#9ca3af" }}>
                "AI Mystery Stories" and "Minecraft Parkour Backgrounds" are trending!
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div style={{ ...styles.heroSection, alignItems: "flex-start", textAlign: "left" }}>
            ...
            <p style={{ color: "#94a3b8", marginBottom: "30px", fontSize: "16px" }}>
              Select a professional AI tool to start your viral journey for FREE!
            </p>
            ...
            <div style={{ ...styles.createToolContainer, flexWrap: "wrap", gap: "25px" }}>
              ...
              <div style={styles.verticalToolCard}>
                ...
                <div style={styles.toolContent}>
                  ...
                  <p style={styles.toolUsage}>
                    Usage: <span style={{ color: "#0e9119" }}>20 credits</span>
                  </p>
                  <p style={styles.toolDescription}>
                    Make viral clips in 1 minute using Flash Create technology!
                  </p>
                  <button onClick={() => router.push("/flashcreate")} style={styles.startBtn}>
                    START
                  </button>
                </div>
              </div>
              ...
              <div style={{ ...styles.verticalToolCard, border: "1px solid #0e9119" }}>
                ...
                <div style={styles.toolContent}>
                  ...
                  <p style={styles.toolUsage}>
                    Usage: <span style={{ color: "#0e9119" }}>15 - 45 credits</span>
                  </p>
                  <p style={styles.toolDescription}>
                    Analyze any channel niche and get a full AI content schedule.
                  </p>
                  <button
                    onClick={() => router.push("/analyze")}
                    style={{ ...styles.startBtn, backgroundColor: "#07db47" }}
                  >
                    ANALYZE
                  </button>
                </div>
              ...
              <div style={{ ...styles.verticalToolCard, border: "1px solid #0e9119" }}>
                ...
                <div style={styles.toolContent}>
                  ...
                  <p style={styles.toolUsage}>
                    Usage: <span style={{ color: "#0e9119" }}>25 credits</span>
                  </p>
                  <p style={styles.toolDescription}>
                    Create hook-heavy viral scripts and plot twists instantly.
                  </p>
                  <button
              ...
              <div style={{ ...styles.verticalToolCard, border: "1px solid #0e9119" }}>
                ...
                <div style={styles.toolContent}>
                  ...
                  <p style={styles.toolUsage}>
                    Usage: <span style={{ color: "#0e9119" }}>5 credits</span>
                  </p>
                  <p style={styles.toolDescription}>
                    Turn any idea into a high-retention video script via ChatGPT-4o API.
                  </p>
                  <button
                    onClick={() => router.push("/scriptwriter")}
                    style={{
                      ...styles.startBtn,
                      backgroundColor: "#07db47",
            ...
            <div style={styles.pricingGrid}>
              <div style={styles.priceCard}>
                ...
                <button
                  ...
                  style={{ ...styles.planBtn, border: "1px solid #60a5fa", color: "#60a5fa" }}
                >
                  Buy Now
                </button>
              </div>
              ...
              <div style={styles.priceCard}>
                ...
                <button
                  onClick={() => buyCredits(60)}
                  style={{ ...styles.planBtn, border: "1px solid #a78bfa", color: "#a78bfa" }}
                >
                  Buy Now
                </button>
              </div>
              ...
              <div style={{ ...styles.priceCard, ...styles.highlightCard }}>
                ...
                <button onClick={() => buyCredits(120)} style={styles.viralBtn}>
                  Buy Now
                </button>
              </div>
            </div>
              ...
              <div style={styles.profileCardSide}>
                ...
                <div style={styles.statsBox}>
                  ...
                  <div style={styles.infoRow}>
                    ...
                    <span style={styles.infoValue}>{userStats.joinDate}</span>
                  </div>
                  <div style={styles.infoRow}>
                    <span style={styles.infoLabel}>User Rank:</span>{" "}
                    <span style={styles.infoValue}>#{userStats.rank}</span>
                  </div>
                </div>
              </div>
        ...
        return (
          <div style={styles.heroSection}>
            ...
            <p style={styles.aboutText}>
              StoryForge AI is the engine of your digital empire. We transform content creation
              from a chore into a single click.
            </p>

            <div style={styles.aboutGrid}>
              <div style={styles.aboutCard}>
                <h3>🎯 The Mission</h3>
                <p>We democratize content creation for everyone.</p>
              </div>
              <div style={styles.aboutCard}>
                <h3>⚡ The Speed</h3>
            ...
            <div style={styles.authorSection}>
              <p style={styles.signature}>
                Developed by <span style={styles.highlightName}>TomX</span>
              </p>
              <p style={styles.copyright}>
                © 2026 storyforgeai • All Rights Reserved
              </p>
            </div>
          </div>
        );
...
// ⭐⭐⭐ MARADÉKTALANUL SZÓ SZERINT MINDEN STÍLUSOD ITT VAN ⭐⭐⭐
